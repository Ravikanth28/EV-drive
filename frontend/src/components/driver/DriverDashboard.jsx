      ...
      <aside className="sidebar">
        ...
        <div style={{ padding: '16px', borderBottom: '1px solid var(--sidebar-border)' }}>
          <div style={{
            ...
            <div style={{ color: '#000000ff', fontWeight: '700', fontSize: '14px', textAlign: 'center' }}>
              {user.name || driverName(driverId)}
            </div>
        ...
        <div className="sidebar-footer">
          <div className="sidebar-user-card" style={{ marginBottom: '10px' }}>
            ...
            <div>
              <div className="sidebar-user-name" style={{ fontSize: '12px' }}>{user.name || `Driver #${driverId}`}</div>
        ...
        <div className="topbar">
          <div className="topbar-left">
            ...
            <div>
              ...
              <div className="topbar-sub">{activeTabDetails?.sub} — {user.name || `Driver #${driverId}`}</div>
            </div>
          </div>
